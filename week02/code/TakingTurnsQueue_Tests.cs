...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: 1. In the Enqueue function of the PersonQueue, it should insert new person base on the length of the array.
                //      2. In the GetNextPerson function, it should check if a person's turns is less than or equal to zero after subtracting 1.
    ...
    // Defect(s) Found: Like the last one
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: It should create a new property of the initial value of turns, so we will know we should in the queue forever.
